...
class StakingRepositoryImpl @Inject constructor(
    ...
    override fun getEnterStaking(address: String, size: Int): Single<List<DomainTransaction>> {
    ...
    override fun getExitStaking(address: String, size: Int): Single<List<DomainTransaction>> {
    ...
    override fun getExitStakingWithPenalty(address: String, size: Int): Single<List<DomainTransaction>> {
